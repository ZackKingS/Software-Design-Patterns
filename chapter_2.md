...
**王哥**（喝完最后一口咖啡，把纸杯扔进垃圾桶）：“第一招，我们来学整个武林中最简单、但也是面试官最爱考的一招——**单例模式 (Singleton)**。你准备好如何保证这个世界上只有一个‘你’了吗？”

> [!TIP]
> **预告**
> 下一章，王哥将手把手带小白见识“单例模式”的各种写法（饿汉、懒汉、双重检查锁），看看为什么一个简单的 `new` 对象，能搞出那么多门道！
